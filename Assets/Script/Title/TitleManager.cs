...
public class TitleManager : MonoBehaviour
{
    ...
    private void MoveTitleName() => TitleNameObj.transform.position = new Vector3(TitleNameObj.transform.position.x, TitleNameObj.transform.position.y + Mathf.Sin(Time.time * 1f) * 0.2f, 0);
    #region 타이틀 버튼 관련 함수
